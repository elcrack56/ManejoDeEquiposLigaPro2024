...
namespace ManejoDeEquiposLigaPro2024.Controllers
{
    public class EstadiosController : Controller
    {
        private readonly ManejoDeEquiposLigaPro2024Context _context;

        public EstadiosController(ManejoDeEquiposLigaPro2024Context context)
        {
            _context = context;
        }
